...
def create_database():
    ...
    cursor.execute("""
        ...
        CREATE TABLE IF NOT EXISTS predictions (
            ...
            special_event INTEGER NOT NULL,
    ...
    cursor.execute("""
        ...
        CREATE TABLE IF NOT EXISTS users (
            ...
            role TEXT DEFAULT 'Mess Manager',
...
# ==========================================
# GET TOTAL NUMBER OF WASTE RECORDS
# ==========================================

def get_waste_record_count():
